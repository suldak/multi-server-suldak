...
@Value
public class PartyGuestCompleteJobDto implements JobDtoInterface {
    Long id;
    ...
    public static PartyRecruitmentEndJobDto of (
        ...
        return new PartyRecruitmentEndJobDto(
                ...
                PartyBatchType.SET_GUEST_COMPLETE,
                JobIdentity.PARTY_BATCH_JOB_GUEST_COMPLETE.getName() + partySchedule.getParty().getId(),
                JobIdentity.PARTY_BATCH_TRIGGER_GUEST_COMPLETE.getName() + partySchedule.getParty().getId(),
