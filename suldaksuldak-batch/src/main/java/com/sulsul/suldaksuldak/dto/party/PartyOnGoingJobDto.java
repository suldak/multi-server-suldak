...
@Value
public class PartyOnGoingJobDto implements JobDtoInterface {
    Long id;
    ...
    public static PartyRecruitmentEndJobDto of (
        ...
        return new PartyRecruitmentEndJobDto(
                ...
                PartyBatchType.SET_ON_GOING,
                JobIdentity.PARTY_BATCH_JOB_ON_GOING.getName() + partySchedule.getParty().getId(),
                JobIdentity.PARTY_BATCH_TRIGGER_ON_GOING.getName() + partySchedule.getParty().getId(),
