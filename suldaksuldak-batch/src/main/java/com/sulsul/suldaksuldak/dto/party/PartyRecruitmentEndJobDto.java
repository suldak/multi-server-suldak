...
@Value
public class PartyRecruitmentEndJobDto implements JobDtoInterface {
    Long id;
    ...
    public static PartyRecruitmentEndJobDto of (
        ...
        return new PartyRecruitmentEndJobDto(
                ...
                PartyBatchType.SET_RECRUITMENT_END,
                JobIdentity.PARTY_BATCH_JOB_RECRUITMENT_END.getName() + partySchedule.getParty().getId(),
                JobIdentity.PARTY_BATCH_TRIGGER_RECRUITMENT_END.getName() + partySchedule.getParty().getId(),
